...
public class Knn {
    ...
    public AlmacenDatos getPuntosVecinos(List<Punto> puntosClass, int cantVecinos) {
        ...
        ArrayList<ArrayList<Punto>> puntosSalida = new ArrayList<>();
    ...
    public String clasificarPuntos(List<Punto> puntosClass, ArrayList<ArrayList<Punto>> puntosVecinos){
        String salida = "\n - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n"
                        + "Clasificacion:\n"
                        + "- - - - - - - - - - - - - - - - - - - - - - - - - - - -\n";
